...
if("FALSE" STREQUAL "TRUE")
  set(slave_SOURCE_PREFIX /home/devlon/Documents/raspberry-pi/ros_stuff/src/slave)
  set(slave_DEVEL_PREFIX /home/devlon/Documents/raspberry-pi/ros_stuff/devel)
  set(slave_INSTALL_PREFIX "")
  set(slave_PREFIX ${slave_DEVEL_PREFIX})
else()
  set(slave_SOURCE_PREFIX "")
  set(slave_DEVEL_PREFIX "")
  set(slave_INSTALL_PREFIX /home/devlon/Documents/raspberry-pi/ros_stuff/install)
  set(slave_PREFIX ${slave_INSTALL_PREFIX})
endif()
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'slave' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/devlon/Documents/raspberry-pi/ros_stuff/install/lib;/home/devlon/Documents/raspberry-pi/ros_stuff/devel/lib;/opt/ros/noetic/lib)
